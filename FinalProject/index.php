...
if (isset($_POST["submit"])) {
  ...
  $query3 = "SELECT distinct WD.WineID, WD.points,WD.price,WD.winery,WD.region1,WD.province,WD.country FROM `wine_data_1` WD WHERE WD.$attribute1 = '$WineInformation1' and WD.WineID not in (SELECT WD1.WineID FROM `wine_data_1` WD1,`wine_ranking` WK WHERE WD.$attribute1= '$WineInformation1' and WD1.winery= WK.winery) ORDER BY WD.$order1 DESC LIMIT 0 , 30";
  $query4 = "SELECT distinct WD.WineID, WD.points,WD.price,WD.winery,WD.region1,WD.province,WD.country FROM `wine_data_2` WD WHERE WD.$attribute1 = '$WineInformation1' and WD.WineID not in (SELECT WD1.WineID FROM `wine_data_2` WD1,`wine_ranking` WK WHERE WD.$attribute1= '$WineInformation1' and WD1.winery= WK.winery) ORDER BY WD.$order1 DESC LIMIT 0 , 30";
...
?>
  <tr>
    ...
    <td><?php echo "<a href='top_100.php?id=".$rs1[0]."' target='_blank' >Yes</a>"?></td>
  </tr>
...
?>
  <tr>
    ...
    <td><?php echo "<a href='top_100.php?id=".$rs2[0]."' target='_blank'>Yes</a>"?></td>
  </tr>
